/**
 * Unable to use unit tests right now in CI since tensorflow-node has issues running on ubuntu
*/

import { findDogBreed } from "./detectDogBreed";
...
// import { detectImageObject, detectDogBreed, findDogBreed } from './detectDogBreed';
